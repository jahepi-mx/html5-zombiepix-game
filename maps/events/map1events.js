    ...
    update(deltatime) {
        if (this.executed === false) {
            if (this.tile.collide(this.map.zombieKiller)) {
                ...
                var eyeSize = this.map.tileWidth * 1.2;
                this.zombieSnake1 = new ZombieSnake(52 * this.map.tileWidth + this.map.tileWidth / 2 - eyeSize / 2, 20 * this.map.tileHeight + this.map.tileHeight / 2 - eyeSize / 2, eyeSize, eyeSize, this.map);
                this.zombieSnake2 = new ZombieSnake(48 * this.map.tileWidth + this.map.tileWidth / 2 - eyeSize / 2, 16 * this.map.tileHeight + this.map.tileHeight / 2 - eyeSize / 2, eyeSize, eyeSize, this.map);
                this.zombieSnake3 = new ZombieSnake(56 * this.map.tileWidth + this.map.tileWidth / 2 - eyeSize / 2, 16 * this.map.tileHeight + this.map.tileHeight / 2 - eyeSize / 2, eyeSize, eyeSize, this.map);

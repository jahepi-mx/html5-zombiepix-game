...
class Assets {
    ...
    constructor() {
        ...
        this.audio = {};
        this.audio.srcs = ["assets/audios/enemy_shoot.mp3", "assets/audios/crate_damage.mp3", "assets/audios/shoot.mp3", "assets/audios/explosion.mp3", "assets/audios/bullet_explosion.mp3", "assets/audios/life.mp3", "assets/audios/main_music.mp3", "assets/audios/game_music.ogg", "assets/audios/boss_music.ogg", "assets/audios/ending_music.mp3"];
        this.audio.keys = ["enemy_shoot", "crate_damage", "shoot", "explosion", "bullet_explosion", "life", "main_music", "game_music", "boss_music", "ending_music"];
